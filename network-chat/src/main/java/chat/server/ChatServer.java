...
import chat.client.AuthException;
import chat.client.TextMessage;
import chat.server.auth.AuthService;
import chat.server.auth.AuthServiceJdbcImpl;
import chat.server.persistance.UserRepository;
...
import static chat.client.MessagePatterns.AUTH_FAIL_RESPONSE;
import static chat.client.MessagePatterns.AUTH_SUCCESS_RESPONSE;
